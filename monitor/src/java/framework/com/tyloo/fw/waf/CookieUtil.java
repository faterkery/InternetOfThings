...
public class CookieUtil {
	...
	//private static final String DOMAIN = Config.getString("sys.domain", ".renhenet.com");
	...
	private void addCrypticCookie(String cookieName, String cookieValue) {
		...
		if (COOKIE_CLIENT_DATA.equals(cookieName)) {
			...
			userDomain = Config.getString("sys.oldrenhe.domain", ".renhenet.com");
			age = 99999999;
		} else {
			age = -1;
		}
