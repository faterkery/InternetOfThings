 ...
 * 
 * @author haoxz11
 * @created Nov 8, 2007 10:46:43 AM
 * @version $Id: FCKeditor.java,v 1.1.1.1 2008/01/22 05:25:25 luoxn Exp $
 */
public class FCKeditor {
     ...
     * <li>basePath: context root + "/editor/"</li>
     * </ul>
     * </p>
     *
	...
	public FCKeditor(HttpServletRequest req){
		request=req;
		basePath = request.getContextPath() + "/editor/";
     ...
     *
     * The basePath is context root + "/editor/"
     *
     * @param req request object
     * @param parInstanceName unique name
